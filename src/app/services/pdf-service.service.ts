      ...
      content: [
        ...
        // Sección superior con la foto del paciente y datos
        {
          columns: [
            ...
            {
              width: 'auto',
              image: 'data:image/png;base64,'+ await this.getDataUrl("https://firebasestorage.googleapis.com/v0/b/pac-clinica.appspot.com/o/assets%2Flogo.png?alt=media&token=02288898-6b76-451c-b4cc-b150f889097e"), // Reemplaza con la URL real del logo de la clínica
