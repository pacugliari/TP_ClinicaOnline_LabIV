...
export class MiPerfilComponent {
  ...
  constructor(private auth: AuthService,private firestore:FirestoreService,private formBuilder:FormBuilder){
  ...
  form = this.formBuilder.group({
    ...
    duracionTurnoLunes : [30,[Validators.required,Validators.min(30),Validators.max(60)]],
    ...
    duracionTurnoMartes : [30,[Validators.required,Validators.min(30),Validators.max(60)]],
    ...
    duracionTurnoMiercoles : [30,[Validators.required,Validators.min(30),Validators.max(60)]],
    ...
    duracionTurnoJueves : [30,[Validators.required,Validators.min(30),Validators.max(60)]],
    ...
    duracionTurnoViernes : [30,[Validators.required,Validators.min(30),Validators.max(60)]],
    sabado: [false], // Para el checkbox de lunes
    sabadoDesde: ['08:00',[Validators.required,this.horarioValido("sabado")]], // Para la hora de inicio del lunes
    sabadoHasta: ['14:00',[Validators.required,this.horarioValido("sabado")]], // Para la hora de fin del lunes
    sabadoEspecialidad: ['',[Validators.required]],
    duracionTurnoSabado : [30,[Validators.required,Validators.min(30),Validators.max(60)]]
  });
  ...
  async actualizar(){
    ...
    if(this.horarios.length){
      ...
      this.form = this.formBuilder.group({
        ...
        lunesDesde: [this.horarios[0].data.horarios.lunesDesde,[Validators.required,this.horarioValido()]], // Para la hora de inicio del lunes
        lunesHasta: [this.horarios[0].data.horarios.lunesHasta,[Validators.required,this.horarioValido()]], // Para la hora de fin del lunes
        lunesEspecialidad: [this.horarios[0].data.horarios.lunesEspecialidad,[Validators.required]],
        duracionTurnoLunes : [this.horarios[0].data.horarios.duracionTurnoLunes,[Validators.required,Validators.min(30),Validators.max(60)]],
        martes: [this.horarios[0].data.horarios.martes], // Para el checkbox de lunes
        martesDesde: [this.horarios[0].data.horarios.martesDesde,[Validators.required,this.horarioValido()]], // Para la hora de inicio del lunes
        martesHasta: [this.horarios[0].data.horarios.martesHasta,[Validators.required,this.horarioValido()]], // Para la hora de fin del lunes
        martesEspecialidad: [this.horarios[0].data.horarios.martesEspecialidad,[Validators.required]],
        duracionTurnoMartes : [this.horarios[0].data.horarios.duracionTurnoMartes,[Validators.required,Validators.min(30),Validators.max(60)]],
        miercoles: [this.horarios[0].data.horarios.miercoles], // Para el checkbox de lunes
        miercolesDesde: [this.horarios[0].data.horarios.miercolesDesde,[Validators.required,this.horarioValido()]], // Para la hora de inicio del lunes
        miercolesHasta: [this.horarios[0].data.horarios.miercolesHasta,[Validators.required,this.horarioValido()]], // Para la hora de fin del lunes
        miercolesEspecialidad: [this.horarios[0].data.horarios.miercolesEspecialidad,[Validators.required]],
        duracionTurnoMiercoles : [this.horarios[0].data.horarios.duracionTurnoMiercoles,[Validators.required,Validators.min(30),Validators.max(60)]],
        jueves: [this.horarios[0].data.horarios.jueves], // Para el checkbox de lunes
        juevesDesde: [this.horarios[0].data.horarios.juevesDesde,[Validators.required,this.horarioValido()]], // Para la hora de inicio del lunes
        juevesHasta: [this.horarios[0].data.horarios.juevesHasta,[Validators.required,this.horarioValido()]], // Para la hora de fin del lunes
        juevesEspecialidad: [this.horarios[0].data.horarios.juevesEspecialidad,[Validators.required]],
        duracionTurnoJueves : [this.horarios[0].data.horarios.duracionTurnoJueves,[Validators.required,Validators.min(30),Validators.max(60)]],
        viernes: [this.horarios[0].data.horarios.viernes], // Para el checkbox de lunes
        viernesDesde: [this.horarios[0].data.horarios.viernesDesde,[Validators.required,this.horarioValido()]], // Para la hora de inicio del lunes
        viernesHasta: [this.horarios[0].data.horarios.viernesHasta,[Validators.required,this.horarioValido()]], // Para la hora de fin del lunes
        viernesEspecialidad: [this.horarios[0].data.horarios.viernesEspecialidad,[Validators.required]],
        duracionTurnoViernes : [this.horarios[0].data.horarios.duracionTurnoViernes,[Validators.required,Validators.min(30),Validators.max(60)]],
        sabado: [this.horarios[0].data.horarios.sabado], // Para el checkbox de lunes
        sabadoDesde: [this.horarios[0].data.horarios.sabadoDesde,[Validators.required,this.horarioValido("sabado")]], // Para la hora de inicio del lunes
        sabadoHasta: [this.horarios[0].data.horarios.sabadoHasta,[Validators.required,this.horarioValido("sabado")]], // Para la hora de fin del lunes
        sabadoEspecialidad: [this.horarios[0].data.horarios.sabadoEspecialidad,[Validators.required]],
        duracionTurnoSabado : [this.horarios[0].data.horarios.duracionTurnoSabado,[Validators.required,Validators.min(30),Validators.max(60)]]
      });
    }
  }
